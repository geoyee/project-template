...
function(set_work_dirs_force bin_dir)
    ...
    foreach(BUILD_TYPE_CONFIG ${CMAKE_BUILD_TYPE_LIST})
        ...
        set(CMAKE_LIBRARY_OUTPUT_DIRECTORY_${BUILD_TYPE_CONFIG_UP} "${bin_dir}/lib" CACHE PATH "" FORCE)
        set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY_${BUILD_TYPE_CONFIG_UP} "${bin_dir}/lib" CACHE PATH "" FORCE)
        set(CMAKE_RUNTIME_OUTPUT_DIRECTORY_${BUILD_TYPE_CONFIG_UP} "${bin_dir}/bin" CACHE PATH "" FORCE)
        set(CMAKE_PDB_OUTPUT_DIRECTORY_${BUILD_TYPE_CONFIG_UP} "${bin_dir}/bin" CACHE PATH "" FORCE)
    endforeach()
    ...
    set(COMPILE_PDB_OUTPUT_DIRECTORY "${bin_dir}/bin" CACHE PATH "Output directory for PDB files" FORCE)
    message(STATUS "COMPILE_PDB_OUTPUT_DIRECTORY: ${COMPILE_PDB_OUTPUT_DIRECTORY}")
