...
function (set_work_dirs_force bin_dir)
  ...
  foreach (BUILD_TYPE_CONFIG ${CMAKE_BUILD_TYPE_LIST})
    ...
    set(CMAKE_LIBRARY_OUTPUT_DIRECTORY_${BUILD_TYPE_CONFIG_UP}
        "${bin_dir}/${SHARED_BIN_DIR}/${CMAKE_BUILD_TYPE}"
        CACHE PATH "" FORCE)
    set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY_${BUILD_TYPE_CONFIG_UP}
        "${bin_dir}/lib/${CMAKE_BUILD_TYPE}"
        CACHE PATH "" FORCE)
    set(CMAKE_RUNTIME_OUTPUT_DIRECTORY_${BUILD_TYPE_CONFIG_UP}
        "${bin_dir}/bin/${CMAKE_BUILD_TYPE}"
        CACHE PATH "" FORCE)
    set(CMAKE_PDB_OUTPUT_DIRECTORY_${BUILD_TYPE_CONFIG_UP}
        "${bin_dir}/bin/${CMAKE_BUILD_TYPE}"
        CACHE PATH "" FORCE)
  endforeach ()
  set(CMAKE_LIBRARY_OUTPUT_DIRECTORY
      "${bin_dir}/${SHARED_BIN_DIR}"
      CACHE PATH "Output directory for libraries" FORCE)
  ...
  set(CMAKE_RUNTIME_OUTPUT_DIRECTORY
      "${bin_dir}/bin"
      CACHE PATH "Output directory for executables" FORCE)
  message(STATUS "CMAKE_RUNTIME_OUTPUT_DIRECTORY: ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}")
  set(CMAKE_PDB_OUTPUT_DIRECTORY
      "${bin_dir}/bin"
      CACHE PATH "Output directory for PDB files" FORCE)
  message(STATUS "CMAKE_PDB_OUTPUT_DIRECTORY: ${CMAKE_PDB_OUTPUT_DIRECTORY}")
  set(CMAKE_INSTALL_PREFIX
      "${bin_dir}/install/${CMAKE_BUILD_TYPE}"
      CACHE PATH "Global install directory" FORCE)
