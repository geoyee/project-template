...
function(set_work_dirs_force bin_dir)
    if(WIN32)
        set(SHARED_BIN_DIR "bin" CACHE PATH "")
    else()
        set(SHARED_BIN_DIR "lib" CACHE PATH "")
    endif()
    ...
    foreach(BUILD_TYPE_CONFIG ${CMAKE_BUILD_TYPE_LIST})
        ...
        set(CMAKE_LIBRARY_OUTPUT_DIRECTORY_${BUILD_TYPE_CONFIG_UP} "${bin_dir}/${SHARED_BIN_DIR}/${CMAKE_BUILD_TYPE}" CACHE PATH "" FORCE)
    ...
    endforeach()
    set(CMAKE_LIBRARY_OUTPUT_DIRECTORY "${bin_dir}/${SHARED_BIN_DIR}" CACHE PATH "Output directory for libraries" FORCE)
